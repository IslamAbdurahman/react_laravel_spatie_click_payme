        ...
        <>
            <div className="flex gap-4">
                <button
                    ...
                    className="hover:bg-primary/15 bg-primary border-primary flex w-full items-center justify-center gap-2.5 rounded-lg border p-3.5 text-white hover:text-black"
                >
                    Google
